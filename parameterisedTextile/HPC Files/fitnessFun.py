...
with open(history_filename, "r") as history_file:
	for my_line in history_file:
		...
		if ( params == input):
			...
			ArealDensity_res_line=allLines[1]
			E0_x_res_line=allLines[2]
			OFV1 = float(E0_x_res_line[7:-1])
			#This won't work but reminder - George
			OFV2 = float(ArealDensity_res_line[15:-1])
			break            
...
if ( results_not_found ):
	...
	# JobfromInput=mdb.JobFromInputFile(name="optim_" + results_id, inputFileName="optim_" + results_id +'.inp', numCpus=6,numDomains=6, memory=80)
	...
	submit = subprocess.call(['sbatch Submit.sh ' + str(ModelName)], shell = True)
	...
	try:
		...
		res_file.write("ArealDensity : " + str(2) + "\n")
		res_file.write("E0_x : " + str(1000000) + "\n")
		res_file.write("E0_y : " + str(1000000) + "\n")
		res_file.write("E0_z : " + str(1000000) + "\n")
		res_file.write("v0_xy : " + str(1000000) + "\n")
		res_file.write("v0_xz : " + str(1000000) + "\n")
		res_file.write("v0_yx : " + str(1000000) + "\n")
		res_file.write("v0_yz : " + str(1000000) + "\n")
		res_file.write("v0_zx : " + str(1000000) + "\n")
		res_file.write("v0_zy : " + str(1000000) + "\n")
		res_file.write("G0_xy : " + str(1000000) + "\n")
		res_file.write("G0_yz : " + str(1000000) + "\n")
		res_file.write("G0_zx : " + str(1000000) + "\n")
		res_file.close()
