...
sys.path.append('$HOME\Python-2.7.16\Lib\site-packages')
...
if nly==4:
	...
	volume=length*height*width
	ModelName= "testweave"
	print("NumNodes=", (NumXVoxels+1)*(NumYVoxels+1)*(2*(NumZVoxels+1)))
	...
	rv.SaveVoxelMesh(t, FileName, NumXVoxels, NumYVoxels, NumZVoxels*2, True, True, True, NO_BOUNDARY_CONDITIONS, 0)
